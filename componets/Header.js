    ...
    return (
      <div className="bg-dark">
        <header className="d-flex flex-wrap justify-content-center py-3 mb-4 mx-4">
          ...
          <Image src="/logo.png" height="35" width="35" style={{marginRight:"10px",borderRadius:"50%",backgroundColor:"#007bff",padding:"5px",display:"flex",alignItems:"center",justifyContent:"center"}}/>
